...
def test_sereis_title():
    except_list = (
        ('新装版 2001夜物語 ： 1 (アクションコミックス)', '2001夜物語(アクションコミックス)'),
        ('完本　1976年のアントニオ猪木 (文春文庫)', '1976年のアントニオ猪木(文春文庫)'),
        ('ゲーマーはもっと経営者を目指すべき！　電子特別版', 'ゲーマーはもっと経営者を目指すべき！'),
        ('インベスターZ(10)', 'インベスターZ'),
        ('１１２２（１） (モーニングコミックス)', '１１２２(モーニングコミックス)'),
        ('1793', '1793'),
